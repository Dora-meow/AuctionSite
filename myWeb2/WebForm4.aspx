<%@ Page Title="購買紀錄" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="WebForm4.aspx.cs" Inherits="myWeb2.WebForm4" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <style>
        ...
        .zi_box_1:before{
            border-radius: 15px;
            background: repeating-linear-gradient(-45deg, #a6d3bf, #a6d3bf 5px, #d2f9e8 0, #d2f9e8 10px); /* 條紋顏色 */
            content: '';
            position: absolute;
            top: 0px;
            bottom: 0px;
    ...
    <div align="center">
        ...
        <asp:ListView ID="productList" runat="server" GroupItemCount="2" >
                <EmptyDataTemplate>
                    ...
                    <p style="color: gray; text-align: center; font-size:large;">沒有任何下標紀錄</p>
                </EmptyDataTemplate>
                <EmptyItemTemplate>
                    <td/>
                </EmptyItemTemplate>
                        ...
                        <table >
                            ...
                            <tr>
                                ...
                                <td style="text-align:left;">
                                    ...
                                    <span><b>競標價: </b>NT$<%#:Eval("競標價")%></span><br />
                                    <span><b>下標時間: </b><%#:Eval("購買時間")%></span><br /></td>
                                <td style="width:20px"></td>
                                <td style="text-align:center;">
                                     <span style="color: <%# Convert.ToBoolean(Eval("是否寄郵件")) ? "green" : "red" %>;">
                                        <%# Convert.ToBoolean(Eval("是否寄郵件")) ? "得標<br>成功" : " 未得標 " %>
                                    </span>
                                </td>
                            </tr>
                            <tr style="height:7px"></tr>
